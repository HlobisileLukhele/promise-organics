          ...
          <div className="mt-8">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#8B9D83] hover:bg-[#8B9D83] hover:text-white transition-all group"
              >
