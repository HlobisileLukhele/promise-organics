  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="relative bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden"
          ...
          >
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3d4f3e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex flex-col md:flex-row h-full max-h-[95vh] overflow-y-auto">
              ...
              <div className="md:w-1/2 w-full p-6 md:p-10 overflow-y-auto">
                ...
                <p className="text-[#5a5a5a] leading-relaxed mb-8 text-base">
                  Natural organic product for your hair care routine.
                </p>
                ...
                <div className="mb-8">
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <div className="flex items-baseline gap-2">
                        <span className="text-2xl font-bold text-[#3d4f3e]">
                          R{product?.price || "0"}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
                    ...
                    <button
                      onClick={() => product && addToWishlist({ id: product.id, name: product.name, image: product.image, price: product.price })}
                      className="flex items-center justify-center gap-2 px-6 py-3 border border-gray-300 hover:bg-[#f5f5f0] font-medium transition-colors duration-200 text-[#3d4f3e]"
                    >
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-x-2">
                    <span className="font-semibold text-[#3d4f3e] uppercase text-sm">Category:</span>
                    <span className="text-[#5a5a5a]">{product?.category || "—"}</span>
                  </div>
                </div>
              </div>
            </div>
