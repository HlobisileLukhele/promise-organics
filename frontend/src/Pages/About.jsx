...
const About = () => {
    return (
        <>
            {/* Hero Section */}
            <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-white dark:bg-[#0f1f17]">
                ...
                <div className="container mx-auto px-4 py-20">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-6">
                            <span className="text-[#3d4d3d] dark:text-[#f0f7f2] font-black">Where Passion Meets</span>
                            <br />
                        ...
                        {/* Description */}
                        <p className="text-lg md:text-xl text-[#3d4d3d] dark:text-[#c8dece] font-medium leading-relaxed max-w-3xl mx-auto">
            ...
            <section className="py-20 bg-gradient-to-br from-[#f5f1e8] via-white to-[#faf8f5] dark:from-[#0f1f17] dark:via-[#162d20] dark:to-[#0f1f17] relative overflow-hidden">
                {/* Background Decorations */}
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="relative">
                                <div className="relative bg-white dark:bg-[#1e3d2a] rounded-[3rem] p-8 shadow-2xl border-4 border-[#c8a882]/20 dark:border-[#2d5a3d]">
                                    <div className="aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-[#f5f1e8] to-[#faf8f5] border-2 border-[#c8a882]/30">
                                        <div className="absolute inset-0 flex items-center justify-center">
                                            <div className="text-center space-y-4">
                                                ...
                                                <p className="text-[#3d4d3d] dark:text-[#f0f7f2] font-bold text-xl">Promise</p>
                                    ...
                                    {/* Floating Stat Cards */}
                                    <div className="absolute -right-8 top-1/4 bg-white dark:bg-[#1e3d2a] rounded-2xl p-4 shadow-2xl border-2 border-[#7d9b7a]/30 dark:border-[#2d5a3d]">
                                        <div className="text-center">
                                            <p className="text-3xl font-black text-[#7d9b7a]">3+</p>
                                            <p className="text-xs font-bold text-[#3d4d3d] dark:text-[#f0f7f2]">Years Experience</p>
                                        </div>
                                    </div>
                                    
                                    <div className="absolute -left-8 bottom-1/3 bg-white dark:bg-[#1e3d2a] rounded-2xl p-4 shadow-2xl border-2 border-[#c8a882]/30 dark:border-[#2d5a3d]">
                                        <div className="text-center">
                                            <p className="text-3xl font-black text-[#c8a882]">100%</p>
                                            <p className="text-xs font-bold text-[#3d4d3d] dark:text-[#f0f7f2]">Natural</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center gap-2 bg-white dark:bg-[#1e3d2a] px-5 py-2.5 rounded-full border-2 border-[#c8a882]/40 dark:border-[#2d5a3d] shadow-sm mb-2">
                                    <span className="text-sm font-bold text-[#3d4d3d] dark:text-[#c8dece]">THE FOUNDER</span>
                                </div>
                                
                                <h2 className="text-4xl md:text-5xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] leading-tight">
                                    A Journey Born From <span className="text-[#7d9b7a]">Passion & Purpose</span>
                                </h2>

                                <div className="space-y-4 text-[#3d4d3d] dark:text-[#c8dece] text-lg leading-relaxed">
                                    <p>
                                    ...
                                    <p className="font-bold text-xl text-[#3d4d3d] dark:text-[#c8dece] italic border-l-4 border-[#c8a882] pl-4">
            ...
            <section className="py-20 bg-white dark:bg-[#0f1f17] relative overflow-hidden">
                {/* Background Decorations */}
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-[#c8a882]/10 dark:bg-[#162d20] px-5 py-2.5 rounded-full border-2 border-[#c8a882]/40 dark:border-[#2d5a3d] shadow-sm mb-4">
                                <span className="text-sm font-bold text-[#3d4d3d] dark:text-[#c8dece]">WHAT DRIVES US</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-4">
                                Our Mission & Values
                            </h2>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {/* Value Card 1 */}
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">100% Natural</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Made With Love</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Proven Results</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Chemical-Free</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Community First</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="group bg-white dark:bg-[#1e3d2a] hover:bg-gradient-to-br hover:from-[#f5f1e8] hover:to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border-2 border-[#c8a882]/20 dark:border-[#2d5a3d] hover:border-[#7d9b7a]/40 transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <h3 className="text-xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Eco-Conscious</h3>
                                <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 bg-white dark:bg-[#1e3d2a] px-5 py-2.5 rounded-full border-2 border-[#c8a882]/40 dark:border-[#2d5a3d] shadow-sm mb-4">
                                <span className="text-sm font-bold text-[#3d4d3d] dark:text-[#c8dece]">HOW WE CREATE</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-4">
                            ...
                            <p className="text-lg text-[#3d4d3d] dark:text-[#c8dece] font-medium max-w-2xl mx-auto">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                <div className="flex-1 bg-white dark:bg-[#1e3d2a] rounded-2xl p-6 shadow-lg border-2 border-[#c8a882]/20 dark:border-[#2d5a3d]">
                                    <h3 className="text-2xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Research & Identification</h3>
                                    <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start md:ml-20">
                                ...
                                <div className="flex-1 bg-white dark:bg-[#1e3d2a] rounded-2xl p-6 shadow-lg border-2 border-[#7d9b7a]/20 dark:border-[#2d5a3d]">
                                    <h3 className="text-2xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Natural Ingredient Selection</h3>
                                    <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start md:ml-40">
                                ...
                                <div className="flex-1 bg-white dark:bg-[#1e3d2a] rounded-2xl p-6 shadow-lg border-2 border-[#c8a882]/20 dark:border-[#2d5a3d]">
                                    <h3 className="text-2xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Formulation & Testing</h3>
                                    <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start md:ml-20">
                                ...
                                <div className="flex-1 bg-white dark:bg-[#1e3d2a] rounded-2xl p-6 shadow-lg border-2 border-[#7d9b7a]/20 dark:border-[#2d5a3d]">
                                    <h3 className="text-2xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">Quality Assurance</h3>
                                    <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 items-start">
                                ...
                                <div className="flex-1 bg-white dark:bg-[#1e3d2a] rounded-2xl p-6 shadow-lg border-2 border-[#c8a882]/20 dark:border-[#2d5a3d]">
                                    <h3 className="text-2xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-3">To Your Hair, With Love</h3>
                                    <p className="text-[#3d4d3d]/70 dark:text-[#c8dece] font-medium leading-relaxed">
            ...
            <section className="py-20 bg-white dark:bg-[#0f1f17] relative overflow-hidden">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <h2 className="text-4xl md:text-5xl font-black text-[#3d4d3d] dark:text-[#f0f7f2] mb-6">
                            Ready to Transform Your <span className="text-[#7d9b7a]">Hair Journey</span>?
                        </h2>
                        <p className="text-lg text-[#3d4d3d] dark:text-[#c8dece] font-medium mb-8 max-w-2xl mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-8 mt-12 flex-wrap">
                            <div className="text-center">
                                ...
                                <p className="text-xs md:text-sm text-[#3d4d3d] dark:text-[#c8dece] font-bold uppercase">Natural</p>
                            </div>
                            <div className="w-px h-12 bg-[#c8a882]/30"></div>
                            <div className="text-center">
                                <p className="text-3xl md:text-4xl font-black text-[#c8a882]">2025</p>
                                <p className="text-xs md:text-sm text-[#3d4d3d] dark:text-[#c8dece] font-bold uppercase">Est. Late 2025</p>
                            </div>
                            <div className="w-px h-12 bg-[#c8a882]/30"></div>
